$rootOU = "ipgphotonics.com/CIS"
$allGPOs = Get-GPO -All -Server $rootOU.Split('/')[0]
...
$data | Export-Csv -Path .\BY_IPGDOMAIN_GpoReport20.09.2024.csv -NoTypeInformation -Delimiter ';'